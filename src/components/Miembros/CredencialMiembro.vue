<template>
    <div id="credencial-wrapper">
      <!-- Frente -->
      <div class="credencial credencial-frontal">
        <div class="header">
      ...
      <!-- Reverso -->
      <div class="credencial credencial-reverso">
        ...
        <div class="pie">
          <p>Sistema desarrollado</p>
          <img src="@/assets/logo.png" alt="LOGO" class="logo-sistema" />
        </div>
      </div>
    </div>
  </template>
